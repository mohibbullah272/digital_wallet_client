...
import { Send, DollarSign, FileText, Wallet, Search, X } from 'lucide-react';
import {  useUserSendMoneyMutation, useWalletInfoQuery } from '@/redux/features/userApi/userApi';
...
const UserSendMoney = () => {
  ...
  const [userSendMoney]=useUserSendMoneyMutation()
...
console.log(form)
  ...
  const handleSend = async() => {
    ...
    try {
      const res = await userSendMoney(sendMoneyInfo).unwrap()
      console.log(res)
